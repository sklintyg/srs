...
OS X example:
----
R_HOME=/usr/local/lib/R java -Djava.library.path="/usr/local/lib/R/3.4/site-library/rJava/jri" -Dsrs.resources.folder="/Users/eriklupander/intyg/SRS/src/main/resources" -jar build/libs/*.war --spring.profiles.active=runtime,it,bootstrap,scheduledUpdate
----
