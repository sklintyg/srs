...
class BootstrapData {
    ...
    fun init(measureRepo: MeasureRepository, recommendationRepo: RecommendationRepository,
        ...
        diagnosisRepo.save(PredictionDiagnosis(1, "M75", 0.34, 0.34, 0.51,
        ...
        diagnosisRepo.save(PredictionDiagnosis(2, "M54", 0.26, 0.26, 0.41,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(3, "F41", 0.48, 0.48, 0.65,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(4, "F32", 0.52, 0.52, 0.68,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(5, "F43", 0.37, 0.37, 0.54,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
                        predictPrioRepo.save(PredictionPriority(4, question04)),
                        predictPrioRepo.save(PredictionPriority(5, question05)),
                        predictPrioRepo.save(PredictionPriority(6, question06)))))
        diagnosisRepo.save(PredictionDiagnosis(6, "M79", 0.37, 0.37, 0.54,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
                        predictPrioRepo.save(PredictionPriority(4, question08)),
                        ...
                        predictPrioRepo.save(PredictionPriority(6, question09)))))
        diagnosisRepo.save(PredictionDiagnosis(7, "M53", 0.46, 0.46, 0.63,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
                        predictPrioRepo.save(PredictionPriority(4, question05)),
                        ...
                        predictPrioRepo.save(PredictionPriority(6, question08)))))
        diagnosisRepo.save(PredictionDiagnosis(8, "M17", 0.53, 0.53, 0.69,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question02)),
                        predictPrioRepo.save(PredictionPriority(3, question03)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(9, "M16", 0.59, 0.59, 0.74,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question02)),
                        predictPrioRepo.save(PredictionPriority(3, question03)),
                        predictPrioRepo.save(PredictionPriority(4, question04)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(10, "M19", 0.46, 0.46, 0.63,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question02)),
                        predictPrioRepo.save(PredictionPriority(3, question03)),
                        predictPrioRepo.save(PredictionPriority(4, question07)),
                        predictPrioRepo.save(PredictionPriority(5, question04)),
                        predictPrioRepo.save(PredictionPriority(6, question10)))))
        diagnosisRepo.save(PredictionDiagnosis(11, "M77", 0.21, 0.21, 0.35,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(12, "M23", 0.21, 0.21, 0.35,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(13, "G56", 0.09, 0.09, 0.17,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question02)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(14, "S82", 0.31, 0.31, 0.47,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
        ...
        diagnosisRepo.save(PredictionDiagnosis(15, "S83", 0.23, 0.23, 0.37,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question02)),
                        predictPrioRepo.save(PredictionPriority(4, question05)),
                        ...
                        predictPrioRepo.save(PredictionPriority(6, question06)))))
        diagnosisRepo.save(PredictionDiagnosis(16, "S62", 0.11, 0.11, 0.2,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question04)),
                        ...
                        predictPrioRepo.save(PredictionPriority(5, question03)),
                        predictPrioRepo.save(PredictionPriority(6, question10)))))
        diagnosisRepo.save(PredictionDiagnosis(17, "S52", 0.17, 0.17, 0.29,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question04)),
                        predictPrioRepo.save(PredictionPriority(3, question10)),
                        predictPrioRepo.save(PredictionPriority(4, question06)),
                        ...
                        predictPrioRepo.save(PredictionPriority(6, question05)))))
        diagnosisRepo.save(PredictionDiagnosis(18, "M51", 0.46, 0.46, 0.63,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question02)),
                        predictPrioRepo.save(PredictionPriority(4, question06)),
                        ...
                        predictPrioRepo.save(PredictionPriority(6, question04)))))
        diagnosisRepo.save(PredictionDiagnosis(19, "F31", 0.65, 0.65, 0.79,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        ...
                        predictPrioRepo.save(PredictionPriority(5, question04)),
                        predictPrioRepo.save(PredictionPriority(6, question05)))))
        diagnosisRepo.save(PredictionDiagnosis(20, "R52", 0.35, 0.35, 0.52,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
                        predictPrioRepo.save(PredictionPriority(4, question08)),
                        predictPrioRepo.save(PredictionPriority(5, question05)),
                        predictPrioRepo.save(PredictionPriority(6, question04)))))
        diagnosisRepo.save(PredictionDiagnosis(21, "F33", 0.52, 0.52, 0.68,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
                        predictPrioRepo.save(PredictionPriority(4, question05)),
                        predictPrioRepo.save(PredictionPriority(5, question04)),
                        predictPrioRepo.save(PredictionPriority(6, question08)))))
        diagnosisRepo.save(PredictionDiagnosis(22, "R53", 0.35, 0.35, 0.52,
                listOf(predictPrioRepo.save(PredictionPriority(1, question01)),
                        predictPrioRepo.save(PredictionPriority(2, question03)),
                        predictPrioRepo.save(PredictionPriority(3, question07)),
                        predictPrioRepo.save(PredictionPriority(4, question08)),
